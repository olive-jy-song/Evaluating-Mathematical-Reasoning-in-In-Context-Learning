...
from submission import addition_prompt, masked_addition_prompt, subtraction_prompt, masked_subtraction_prompt, multiplication_prompt, masked_multiplication_prompt, your_config, your_api_key, your_post_processing, your_pre_processing
import together
...
if __name__ == '__main__':
    ...
    for trial in range(4): # do 4 trials because same data same prompt could yield different result
        ...
        res_large = test_range(masked_multiplication_prompt(), student_config, n_sample=30, rng=rng,
                            fixed_pairs=[(321,3)],
                            lower_bound_1=100, upper_bound_1=999, lower_bound_2=1, upper_bound_2=9, 
